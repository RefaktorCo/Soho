 ...
 */
function soho_preprocess_username(&$vars) {
  global $theme_key;
 ...
 */
function soho_process_page(&$variables) {	
...
*/
function soho_preprocess_html(&$vars){
  global $user;
  $viewport = array(
    '#type' => 'html_tag',
    '#tag' => 'meta',
 ...
 */
function soho_preprocess_block(&$vars) {
 ...
 */
function soho_form_alter(&$form, &$form_state, $form_id) {
...
*/
function soho_form_contact_site_form_alter(&$form, &$form_state, $form_id) {
  global $user;
...
*/
function soho_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
function soho_block_view_alter(&$data, $block) {
 ...
 */
function soho_item_list($variables) {
