<?php 
  if (!isset($content['field_media_embed'])) { drupal_add_js(drupal_get_path('theme', 'soho') .'/js/portfolio/portfolio_without_info_image.js'); } if (isset($content['field_media_embed'])) { drupal_add_js(drupal_get_path('theme', 'soho') .'/js/portfolio/portfolio_without_info_video.js'); 
	}
?>   
...
<div class="fullscreen-gallery">
  <div class="fs_grid_gallery">	
    ...
    <div class="slider_info fw_slider_info">
      ...
      <?php if (!$teaser && module_exists('soho_utilities') && theme_get_setting('portfolio_meta_share') == '1'): ?>
      <div class="slider_share">
        <?php print theme('soho_social_share', array('title' => $title, 'link' => $base_url.'/node/'.$nid, 'image' => $share_image)); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="post_meta_data">
        ...
        <div class="post_controls">
          <?php if (soho_node_pagination($node, 'p') != NULL) : ?>
        	  <div class="fleft"><a href="<?php print url('node/' . soho_node_pagination($node, 'p'), array('absolute' => TRUE)); ?>" rel="prev"></a></div>
          <?php endif; ?>
          <?php if (soho_node_pagination($node, 'n') != NULL) : ?>
            <div class="fright"><a href="<?php print url('node/' . soho_node_pagination($node, 'n'), array('absolute' => TRUE)); ?>" rel="next"></a></div> 
          <?php endif; ?>
